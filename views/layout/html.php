...
<html lang="en" class="govuk-template lbh-template ">
    <head>
        <meta charset="utf-8">
        <title>Coronavirus - Support for Hackney residents | Hackney Council</title>
    ...
    <body class="govuk-template__body ">
        ...
        <a href="#main-content" class="govuk-skip-link  lbh-skip-link">Skip to main content</a>
                    ...
                    <div class="lbh-header__title">
                        <a href="/" class="lbh-header__title-link">
                            ...
                            >
                                ...
                                <image src="/assets/images/lbh-logo.png" xlink:href="" class="lbh-header__logo-fallback-image" width="206" height="37"></image>
                            </svg>
                            <span class="lbh-header__logo-text">Hackney</span>
                            <span class="lbh-header__service-name ">Support for Hackney residents</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <a href="#top" class="lbh-back-to-top" data-module="lbh-back-to-top">
            <svg class="lbh-back-to-top__icon" width="31px" height="31px" viewBox="0 0 31 31" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
